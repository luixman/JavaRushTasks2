    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            ...
            public int compare(Stock o1, Stock o2) {
                long oneDay = 24 * 60 * 60 * 1000; //ms of day
                Long d1 = ((Date) o1.get("date")).getTime() / oneDay;
                Long d2 = ((Date) o2.get("date")).getTime() / oneDay;
                return d2.compareTo(d1);
            }
        }).thenComparing(new Comparator<Stock>() {
            @Override
            public int compare(Stock o1, Stock o2) {
                int profit1 =getProfitPercentage(o1);
                int profit2 =getProfitPercentage(o2);
